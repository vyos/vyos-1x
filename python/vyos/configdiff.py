...
class ConfigDiff(object):
    ...
    def __init__(self, config, key_mangling=None):
        ...
        self._session_config_dict = config.get_cached_root_dict(effective=False, multi=False)
        self._effective_config_dict = config.get_cached_root_dict(effective=True, multi=False)
