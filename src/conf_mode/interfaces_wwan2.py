...
def build_config(raw_cfg):
    ...
    sim1 = {
        'slot': 1,
        'apn': raw_cfg.get('sim_slot_1_apn', raw_cfg.get('apn', '')),
        'username': raw_cfg.get('sim_slot_1_username', raw_cfg.get('username', '')),
        'password': raw_cfg.get('sim_slot_1_password', raw_cfg.get('password', '')),
    ...
    if any(key.startswith('sim_slot_2_') for key in raw_cfg.keys()):
        sim2 = {
            'slot': 2,
            'apn': raw_cfg.get('sim_slot_2_apn', raw_cfg.get('apn', '')),
            'username': raw_cfg.get('sim_slot_2_username', raw_cfg.get('username', '')),
            'password': raw_cfg.get('sim_slot_2_password', raw_cfg.get('password', '')),
