...
def get_config():
    ...
    if not (conf.exists('protocols rip') or conf.exists_effective('protocols rip')):
        return None

    if conf.exists('protocols rip'):
        rip_conf['rip_conf'] = True

    conf.set_level('protocols rip')
    ...
    for dist_iface in conf.list_effective_nodes('distribute-list interface'):
        ...
        conf.set_level('protocols rip distribute-list interface ' + dist_iface)
    ...
    conf.set_level('protocols rip distribute-list')
