...
from vyos.utils.kernel import is_crash_kernel_loaded
...
def _get_raw_status() -> dict:
    ...
    return {
        ...
        'crash_kernel_loaded': is_crash_kernel_loaded(),
        'crash_kernel_size': get_crash_kernel_size(),
        'cmdline_value': get_kernel_boot_arg('crashkernel') or '',
...
def _format_status(data: dict) -> str:
    ...
    if data['crash_kernel_loaded']:
        ...
        rows.append(('Reserved memory', bytes_to_human(raw)))
